...
- [Evaluation criteria](overview-evaluation): Provides a checklist which will be used in reviewing and to assess whether the artefacts are available, functional, and reusable.
